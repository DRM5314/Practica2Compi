...
export default class ManejadorSiguientes {
    private producciones: AuxiliarProduccion[];
    private nombresNoTerminales: String[];
    private listadoSiguientes: Siguiente[] = [];
    private primeros: Primeros[];
    private simboloInicial: String;

    constructor(nombres: String[], auxiliaresProd: AuxiliarProduccion[], primeros: Primeros[], simboloInicial: String) {
    ...
    private agregarPadresSiguientes() {
        for (var i in this.nombresNoTerminales) {
            this.listadoSiguientes.push(new Siguiente(this.nombresNoTerminales[i]));
        }
    }
    private calcularSiguientesFase2() {
